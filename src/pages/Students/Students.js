...
class Students extends React.Component{
  nextPath(path) {
    ...
    render(){
        return(
            <div>
            <Navbar pathname='/students' pathnameTitle='Студенты'/>
            <div className="container font-lighter bg-light">
              <div className="row d-flex justify-content-end">
                <div className="col-6 my-3 py-2">
                  <button type="submit" onClick={() => this.nextPath("/students-form")} className="btn btnadd bg-dark border">Добавить</button>
                </div>
              </div>
              <div className="grey-box">
                <div className="row">
                  <div className="col-md-2 fw-bold">Студент:</div>
                ...
                <div className="row my-2">
                  ...
                  <div className="col-md-2">0550 505 505</div>
                  <div className="col-md-2 fw-bold">Логин:</div>
                  <div className="col-md-3">0550 505 505</div>
                </div>
                <div className="row my-2">
                  <div className="col-md-2 fw-bold">Пин код:</div>
                  <div className="col-md-2">0505</div>
                </div>
              </div>
              <div className="grey-box">
                <div className="row">
